...
def index():
    ...
    if len(domain_user)==2:
        ...
        if form.process().accepted:
            ...
            #arg3=groups[profil]
            script=r'C:\Users\unificace\unificace\web2py\applications\init\scripts\gestion_proxy\gestion_proxy_bta.ps1'
        ...
        response.flash = "Il faut utiliser votre nom d'utilisateur avec nom du domaine come par example abc123@hlhl.rtss.qc.ca"
        form=""
