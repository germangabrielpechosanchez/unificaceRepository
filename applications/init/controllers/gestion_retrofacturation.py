...
def importation():
    ...
    #"""
    import subprocess 
    script=r'C:\Users\T2-PEGE8301.06CEMTL\Desktop\environmentTestClonedFromGitHub\unificaceAdmin\web2py\applications\init\scripts\gestion_retrofacturation\read_octopus_retrofacturation.py'
