...
def inscription():
    ...
    if form.accepts(request.vars,session,keepvalues=True):
        ...
        if output[3]=='toreset':
            ...
            mail.settings.server = 'smtp.rtss.qc.ca:25'
            mail.settings.sender = 'unificace@ssss.gouv.qc.ca'
            this_link="https://"+request.env.http_host+"/init/gestion_motdepasse/inscription_receive/"+reset_id
            message="<a  href='"+this_link+"'> Pour finaliser votre inscription, cliquez ici.".decode('utf8')+" </a>"
    ...
    if form.accepts(request.vars,session,keepvalues=True):
        ...
        if can_reset:
            ...
            if output[3]=='toreset':
                ...
                this_link="https://"+request.env.http_host+"/init/gestion_motdepasse/password_receive/"+reset_id
                message="<a  href='"+this_link+"'> Si vous souhaitez changer votre mot de passe, cliquez ici.".decode('utf8')+" </a>"
