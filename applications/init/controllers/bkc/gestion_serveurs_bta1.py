...
def tables_update():
    ...
    this_files=[r'C:\Users\unificace\unificace\web2py\applications\init\scripts\gestion_serveurs\ADs.txt', r'C:\Users\unificace\unificace\web2py\applications\init\scripts\gestion_serveurs\servers_type_update.txt']
    for this_file in this_files:
        f=open(this_file,"r")
        lines=f.readlines()
        #lines=lines[10:30]
    ...
    for this_file in this_files:
        ...
        #db(this_table.id>0).delete()
        #db(this_table.id>0).update(installedDate="installedDate")
    ...
    #update servers_octopus
    #this_file=r'C:\Users\unificace\unificace\web2py\applications\init\scripts\gestion_serveurs\hosts.txt'
    this_files=[r'C:\Users\unificace\unificace\web2py\applications\init\scripts\gestion_serveurs\servers_octopus.txt', ]
    for this_file in this_files:
        f=open(this_file,"r")
        lines=f.readlines()
        #lines=lines[0:40]
        this_table=db.octopus_servers
    ...
    #response.flash = str(len(cols))+installedDate+msg+str(this_rec)
    response.flash = T(u'terminé')
