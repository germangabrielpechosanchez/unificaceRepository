    ...
    if True:
        ...
        for i in rs_list:
            if len(i[1]):
                ...
                grid+="<tr><th>"+week_begin+"</th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr>"
                #rows rs
                my_i=i[1]
                for j in i[1]:
                    ...
                    #if this_sum_available<hours2:
                    #    hours2=this_sum_available
                    ...
                    if this_groupby=='task_number':
                        ...
                        grid+="<tr><td>"+this_groups+"</td><td>"+this_sum_total+"</td><td></td><td>"+this_sum_effort+"</td><td>"+this_sum_no_effort+"</td><td></td><td>"+this_sum_effort2+"</td><td>"+this_sum_no_effort2+"</td></tr>"
                    else:
                        grid+="<tr><td>"+this_groups+"</td><td>"+this_sum_total+"</td><td></td><td>"+percents+"</td><td "+red_class+">"+this_sum_available+"</td><td>"+this_sum_no_effort+"</td><td></td><td>"+percents2+"</td><td "+red_class+">"+this_sum_available2+"</td><td>"+this_sum_no_effort2+"</td></tr>"
                ...
                for r in rs:
                    ...
                    while r_end<=r.estimated_end:
                        ...
                        qry=(tb2.resources_id==r.resources_id)&\
                            ...
                            (tb2.available_time==0)&\
                            (tb2.total_time==0)&\
                            (tb2.estimated_effort==r_estimated_effort)&\
                            (tb2.estimated_effort==r_estimated_effort2)&\
