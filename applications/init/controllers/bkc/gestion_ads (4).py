...
def creation_comptes():
    ...
    form = SQLFORM.factory(
        ...
        Field('users',type='text',label=T('Liste des utilisateurs à créer'),length=20000,requires=IS_NOT_EMPTY(),comment=T("FORMAT : Prénom nom;titre d'emploi (On peut avoir plus que 100 lignes )"),represent=lambda text, row: XML(text.replace('\n', '<br />'),sanitize=True, permitted_tags=['br/'])),
