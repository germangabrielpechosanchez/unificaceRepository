...
response.menu = [
    (T("Menu"), False, '#', [
        ...
        #(T('Gestion des absences'), False, URL('gestion_absence','index'),[]),
        ...
        #(T('Gestion des identités'), False, URL('gestion_identite', 'index'), []),
        (T('Gestion des factures'), False, URL('gestion_factures', 'index'), []),
        (T('Gestion des inventaires'), False, URL('gestion_serveurs', 'index'), []),
        (T('Gestion des mappages'), False, URL('mappage_reseau', 'index'), []),
        #(T('Gestion des mots de passe'), False, URL('gestion_mdp', 'index'), []),
        (T('Gestion du proxy'), False, URL('gestion_proxy', 'index'), []),
        (T('Gestion des PVS'), False, URL('gestion_pvs', 'index'), []),
        #(T('Gestion de rétrofacturation'), False, URL('gestion_retrofacturation', 'index'), []),
        (T('Gestion RDM & RDP'), False, URL('gestion_rdm_rdp', 'index'), []),
        (T('Gestion des VMs'), False, URL('gestion_vms', 'index'), []),
        ...
        #(T('Gestion du temps'), False, URL('gestion_capacite','index'),[]),
